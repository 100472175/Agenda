import { c as create_ssr_component, d as compute_rest_props, a as setContext, f as spread, h as escape_attribute_value, i as escape_object, j as add_attribute, g as getContext, e as escape, v as validate_component, k as compute_slots, l as createEventDispatcher, o as each } from "../../chunks/ssr.js";
...
const UserEditOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${withEvents ? `<svg${spread(
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="square"${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="M7 19H5a1 1 0 0 1-1-1v-1a3 3 0 0 1 3-3h1m4-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm7.441 1.559a1.907 1.907 0 0 1 0 2.698l-6.069 6.069L10 19l.674-3.372 6.07-6.07a1.907 1.907 0 0 1 2.697 0Z"></path></svg>` : `<svg${spread(
    [
      { xmlns: "http://www.w3.org/2000/svg" },
      { fill: "none" },
      escape_object($$restProps),
    ...
    {}
  )}>${title.id && title.title ? `<title${add_attribute("id", title.id, 0)}>${escape(title.title)}</title>` : ``}${desc.id && desc.desc ? `<desc${add_attribute("id", desc.id, 0)}>${escape(desc.desc)}</desc>` : ``}<path stroke="currentColor" stroke-linecap="square"${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="M7 19H5a1 1 0 0 1-1-1v-1a3 3 0 0 1 3-3h1m4-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm7.441 1.559a1.907 1.907 0 0 1 0 2.698l-6.069 6.069L10 19l.674-3.372 6.07-6.07a1.907 1.907 0 0 1 2.697 0Z"></path></svg>`} `;
});
const css = {
  code: "h1.svelte-192dl9b{margin-top:10px;margin-bottom:20px}#add-contact-container.svelte-192dl9b{margin-top:20px}html{background-color:#E1EFFE;padding:2% 5% 7% 5%}@media(prefers-color-scheme: dark){html{background-color:#E1EFFE;padding:2% 5% 7% 5%}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    contacts.reduce((total, contact) => total + contact.id, 0);
    $$rendered = `<h1 class="bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 text-transparent bg-clip-text text-5xl text-center underline font-extrabold mr-2 svelte-192dl9b" data-svelte-h="svelte-1q70p3g">Lista de Contactos</h1> <div class="justify-center items-center top-12">${contacts.length === 0 ? `<p class="text-center border-gray-900 pb-4 mb-4 text-xl" data-svelte-h="svelte-1q9v5u7">No contacts found</p>` : ``} ${each(contacts, (contacts2, index) => {
      return `<div class="text-center border-gray-900 pb-4 mb-4"> <h2 class="font-bold text-lg">${escape(contacts2.id)} - ${escape(contacts2.name)}</h2> <p>${escape(contacts2.phone)}</p> <p>${escape(contacts2.description)}</p> ${validate_component(ButtonGroup, "ButtonGroup").$$render($$result, { class: " space-x-px" }, {}, {
        default: () => {
          return `${validate_component(GradientButton, "GradientButton").$$render($$result, { pill: true, color: "purpleToBlue" }, {}, {
            default: () => {
              return `${validate_component(UserEditOutline, "UserEditOutline").$$render($$result, { class: "w-5 h-5 me-2" }, {}, {})}
          Edit
        `;
            }
            ...
            {
              footer: () => {
                return `${validate_component(ButtonGroup, "ButtonGroup").$$render($$result, { class: "space-x-px" }, {}, {
                  default: () => {
              ...
              default: () => {
                return `<p>Estamos modificando el contacto de ${escape(contact_temp.name)}, con id: ${escape(contact_temp.id)}</p> ${validate_component(Label, "Label").$$render($$result, { for: "name", class: "mb-2" }, {}, {
                  default: () => {
                    return `Name`;
                  }
                  ...
                  $$result,
                  {
                    ...
                    placeholder: "Name",
                    required: true,
                    value: contact_temp.name
                  },
                  {
                    value: ($$value) => {
                      contact_temp.name = $$value;
                      $$settled = false;
                    }
                  },
                  {}
                )} ${validate_component(Label, "Label").$$render($$result, { for: "phone", class: "mb-2" }, {}, {
                  default: () => {
                    return `Phone number`;
                  }
                })} ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    ...
                    placeholder: "6*********",
                    required: true,
                    value: contact_temp.phone
                  },
                  {
                    value: ($$value) => {
                      contact_temp.phone = $$value;
                      $$settled = false;
                    }
                  },
                  {}
                )} ${validate_component(Label, "Label").$$render($$result, { for: "description", class: "mb-2" }, {}, {
                  default: () => {
                    return `Description`;
                  }
                })} ${validate_component(Input, "Input").$$render(
                  $$result,
                  {
                    ...
                    required: true,
                    value: contact_temp.description
                  },
                  {
                    value: ($$value) => {
                      contact_temp.description = $$value;
                      $$settled = false;
                    }
                  },
                  {}
          ...
          )} ${validate_component(GradientButton, "GradientButton").$$render($$result, { pill: true, color: "purpleToBlue" }, {}, {
            default: () => {
              return `${validate_component(TrashBinOutline, "TrashBinOutline").$$render($$result, { class: "w-5 h-5 me-2" }, {}, {})}Delete`;
            }
          })} ${validate_component(Modal, "Modal").$$render(
            $$result,
            {
            ...
            },
            {
              default: () => {
                return `<div class="text-center">${validate_component(ExclamationCircleOutline, "ExclamationCircleOutline").$$render(
                  ...
                  {},
                  {}
                )} <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Estás seguro de querer eliminar el contacto de ${escape(contact_temp.name)}?</h3> ${validate_component(ButtonGroup, "ButtonGroup").$$render($$result, { class: " space-x-0" }, {}, {
                  default: () => {
                    return `${validate_component(Button, "Button").$$render($$result, { color: "red", class: "" }, {}, {
                      default: () => {
                        return `Si, bórralo
              `;
                      }
      ...
      })}</div> ${index !== contacts2.length - 1 ? `<div class="border-t border-gray-300"></div>` : ``}`;
    })}</div> <div id="add-contact-container" class="grid grid-cols-3 gap-4 svelte-192dl9b"><input id="card-name" type="text" placeholder="Introducir nombre..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"${add_attribute("value", contact_name, 0)}> <input id="card-phone" type="text" placeholder="Introducir teléfono..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"${add_attribute("value", contact_phone, 0)}> <textarea id="card-description" type="text" placeholder="Introducir descripción..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">${escape("")}</textarea>  <div></div> <button id="add-contact-button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:font-bold" data-svelte-h="svelte-g8x8ry">+</button> </div>`;
  } while (!$$settled);
  return $$rendered;
});
export {
